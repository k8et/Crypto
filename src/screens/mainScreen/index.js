    ...
    <div className={styles.pos}>
      <div className={styles.mainScreen}>
        <div className={styles.coinList}>
          {coinGeckoAPI.cryptoData.map((item) => (
              ...
              <div className={styles.coinInfo} onClick={() => openModal(item)}>
                <div className={styles.headerBox}>
                  ...
                  <div className={styles.price}>
                    <span>{parseFloat(item.current_price).toFixed(2)}$</span>
                  </div>
                </div>
                ...
                <div className={styles.volume24h}>
                  <span>
                    <span>{t("mainScreen.title.volume24h")}</span>:{" "}
                    {item.total_volume.toLocaleString()}$
                  </span>
                </div>
                <div className={styles.marketCap}>
                  <span>
                    <span>{t("mainScreen.title.marketCap")}</span>:{" "}
