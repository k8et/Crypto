  ...
  return (
    <div className={styles.pos}>
      <div className={styles.buttonGroup}>
        ...
        <button onClick={() => handleDisplayTop(0, 50)}>
          {t("topCryptoScreen.top50")}
        </button>
        <button onClick={() => handleDisplayTop(50, 80)}>
          {t("topCryptoScreen.top30")}
        </button>
        <button onClick={() => handleDisplayTop(80, 90)}>
          {t("topCryptoScreen.top10")}
        </button>
      </div>
